...
// const {donationSchema,fundReqSchema}=require("./schema.js");
...
const Ngon = require("./Init/model/ngoGovt.js");
const { fundReqSchema } = require("./schema.js");
...
const fundRouter=require("./routes/funds.js");
const raiseFundRouter=require("./routes/raise-funds.js");
...
app.use("/raise-funds",raiseFundRouter);
...
// app.get("/home/disaster-management" ,isLoggedin,(req,res)=>{
...
///SIGNUP FOR USER AND NGO ROUTES---------/////////
...
// app.post("/login/verify-otp",wrapAsync( async (req, res, next) => {
//   try {
...
shownavbar:true,
showfooter:true,
stylePath3:"/css/emergency.css",
  });
})


// app.get("/raise-funds", isNgo,async(req,res)=>{
...
//  app.get("/fund/:action/:id",async(req,res)=>{
